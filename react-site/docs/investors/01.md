...
The total fund pool is 999,000 USDT for the seed phase of this project, and token distribution will be determined based on the specifics of each funding round. Here are some preliminary details:

1. Token Offering: The total number of tokens available at the initial stage will depend on the price per token and the amount of funds raised during the funding. For example, if the price per token is set to 1 USD and the project raises 999,000 USDT, then the total supply of tokens will be 999,000 **$ZLATO** tokens.
2. Distribution of tokens: Tokens will be distributed to investors according to their contribution to the funding round. The distribution will take place in proportion to the contribution of each investor.
   1. Token Sales: 30% is the amount of tokens that will be put up for public sale for public acquisition. This will enable a wide range of investors to participate in the project and make their contribution.
   2. Team and advisors: 20% is the share of tokens that will be allocated to the project team and advisors. This is important to ensure the long-term interest and motivation of the team, as well as to compensate for their efforts and contributions.
   3. Partners and the Ecosystem: 15% - this portion will be used to support partnerships, stimulate the development of the ecosystem and collaborate with other projects and platforms.
   4. Reserves: 15% - will be held in reserve to maintain liquidity, handle future funding rounds and manage unexpected events.
   5. Marketing and community development: 10% - will be used for marketing activities, PR, project promotion, and community development and maintenance. 6. Bounties and Rewards Programs: 10% - This portion of the tokens will be used for bounty programs, which may include token rewards, bounties, airdrops and other incentives for community members.
