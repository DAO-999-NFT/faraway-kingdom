...
export const exploreContents: exploreContentsItem[] = [
  {
    id: 'content-1',
    img: contentImage1,
    content: `Коллекция стала праздником электронной музыки, и было сказано, что обладание NFT принесет коллекционеру удачу, землю в метавселенной 999 и управления в Царстве Тридевятом DAO в придачу.`,
  },
  {
    id: 'content-2',
    img: contentImage2,
    content: `И вот, было объявлено, что 8 марта в волшебном королевстве, в клубе Культ, начнется официальный аукцион коллекции, куда мы приглашаем вас присоединиться к нам на тропическом острове Панган и погрузиться в это с головой за белым кроликом домой.`,
  },
  {
    id: 'content-3',
    img: contentImage3,
